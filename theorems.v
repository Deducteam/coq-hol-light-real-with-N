...
Axiom thm_LENGTH : forall {A : Type'}, ((@LENGTH A (@nil A)) = (NUMERAL N0)) /\ (forall h : A, forall t : list A, (@LENGTH A (@cons A h t)) = (N.succ (@LENGTH A t))).
...
Axiom thm_REPLICATE : forall {A : Type'} (n : N) (x : A), ((@REPLICATE A (NUMERAL N0) x) = (@nil A)) /\ ((@REPLICATE A (N.succ n) x) = (@cons A x (@REPLICATE A n x))).
...
Axiom thm_EL : forall {A : Type'} (n : N) (l : list A), ((@EL A (NUMERAL N0) l) = (@hd A l)) /\ ((@EL A (N.succ n) l) = (@EL A n (@tl A l))).
...
Axiom thm_list_of_seq : forall {A : Type'} (s : N -> A) (n : N), ((@list_of_seq A s (NUMERAL N0)) = (@nil A)) /\ ((@list_of_seq A s (N.succ n)) = (@app A (@list_of_seq A s n) (@cons A (s n) (@nil A)))).
...
Axiom thm_LENGTH_EQ_NIL : forall {A : Type'}, forall l : list A, ((@LENGTH A l) = (NUMERAL N0)) = (l = (@nil A)).
...
Axiom thm_MEM_REPLICATE : forall {A : Type'}, forall n : N, forall x : A, forall y : A, (@List.In A x (@REPLICATE A n y)) = ((x = y) /\ (~ (n = (NUMERAL N0)))).
...
Axiom thm_LENGTH_TL : forall {A : Type'}, forall l : list A, (~ (l = (@nil A))) -> (@LENGTH A (@tl A l)) = (N.sub (@LENGTH A l) (NUMERAL (BIT1 N0))).
...
Axiom thm_EL_TL : forall {A : Type'} (l : list A), forall n : N, (@EL A n (@tl A l)) = (@EL A (N.add n (NUMERAL (BIT1 N0))) l).
Axiom thm_EL_CONS : forall {A : Type'}, forall n : N, forall h : A, forall t : list A, (@EL A n (@cons A h t)) = (@COND A (n = (NUMERAL N0)) h (@EL A (N.sub n (NUMERAL (BIT1 N0))) t)).
Axiom thm_LAST_EL : forall {A : Type'}, forall l : list A, (~ (l = (@nil A))) -> (@LAST A l) = (@EL A (N.sub (@LENGTH A l) (NUMERAL (BIT1 N0))) l).
...
Axiom thm_LIST_OF_SEQ_EQ_NIL : forall {A : Type'}, forall s : N -> A, forall n : N, ((@list_of_seq A s n) = (@nil A)) = (n = (NUMERAL N0)).
